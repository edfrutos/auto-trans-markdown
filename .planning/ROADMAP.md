...
Plans:
- [ ] 06-01-PLAN.md — CLI batch ZIP + tone (DEBT-01)
- [ ] 06-02-PLAN.md — UI Bearer token + fetch/SSE (DEBT-02)
- [ ] 06-03-PLAN.md — Editor multi-idioma tabs/download (DEBT-03)
- [ ] 06-04-PLAN.md — 02-VERIFICATION retroactivo + tests regresión (DEBT-04)
...
| 6. Tech Debt Closure | v2.0 | 0/4 | Not started | — |
